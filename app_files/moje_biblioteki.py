...
def mainPageMenuList():
	...
	menu_list.append(["right","https://www.youtube.com/user/MrRavos/featured","Cryst on YT - pomoce"])
	menu_list.append(["left","https://colab.research.google.com/github/ZPXD/zajecia_programowania_xd/","Zajecia programowania xd"])

	#menu_url_list = []
	#menu_title_list = []
	#for url, title in menu_list:
...
def listExamples():
	...
	list2 = [5,2,5,1,23,5]
	list3 = [[3,'dev'],[2,'ab'],[1,'c'],[7,'warlord'],[4,'qwas']]	
	...
	print('List1_1 = sorted(list1): ',list1_1)
	
	list1.sort()
	print('List1 after list1.sort():',list1)
	
	list1_2 = sorted(list1, key=lambda x: len(x))
	print('List 1 sorted(key=lambda x: len(x)):',list1_2)
...
# 	ip_addr = set(request_remote_addr(), client(), proxy_client(), proxy_client())
